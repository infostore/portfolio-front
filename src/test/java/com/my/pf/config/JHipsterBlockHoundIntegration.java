...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.my.pf.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.my.pf.security.DomainUserDetailsService", "createSpringSecurityUser");
